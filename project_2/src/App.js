...
class App extends Component {
  ...
  componentDidMount(){
    axios({
      method: 'GET',
      url: 'https://en.wikipedia.org/w/api.php?action=query&list=search&srsearch=Craig%20Noone&format=jsonfm',
      mode: 'no-cors',
      headers: {
  ...
  render() {
    ...
    return (
      <div className=''>
        ...
        <footer>
        <div className='bg-secondary text-center icons'><a href={this.state.url[0]} target="_blank" rel="noopener noreferrer"><i class="fab fa-github mr-2"></i></a><a href={this.state.url[1]} target="_blank" rel="noopener noreferrer"><i class="fab fa-linkedin mr-2 ml-2"></i></a><a href={'mailto:'+this.state.url[2]} target="_blank" rel="noopener noreferrer"><i class="fas fa-envelope-square ml-2"></i></a></div>
